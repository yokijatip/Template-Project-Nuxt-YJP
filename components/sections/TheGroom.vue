<template>
  <div>
    <section
      class="snap-section min-h-screen bg-[url(@/assets/images/couple/IMG_3414.jpg)] bg-cover bg-center bg-no-repeat shadow-[inset_0_0_0_2000px_rgba(0,0,0,0.5)] text-primary-white flex flex-col items-start justify-end"
    >
      <!-- Content -->
